...
static void LoadInternal(DatabaseInstance &instance) {
	...
	config.AddExtensionOption("s3_url_style", "S3 URL style", LogicalType::VARCHAR, Value("path"));
	...
	//orig Shubha commented config.AddExtensionOption("s3_uploader_max_parts_per_file", "S3 Uploader max parts per file (between 1 and 10000)",
	config.AddExtensionOption("s3_uploader_max_parts_per_file", "S3 Uploader max parts per file (between 1 and 10000)",
	                          LogicalType::UBIGINT, Value(1));
